...
<body class="bg-login">
    ...
    <div id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <h2><center>Daftar Komentar User</center> </h2> <br>
                ...
                <tbody>
                    <?php foreach ($contact as $u) : ?>
                        <tr align="center" style="background-color: white;color:black">
                            <td><?php echo $u['id_contact']; ?></td>
                            <td><?php echo $u['nama_contact']; ?></td>
                            <td><?php echo $u['email_contact']; ?></td>
                            <td><?php echo $u['pesan']; ?></td>
                            <td>
                                <a href="<?= base_url(); ?>contact/hapus/<?= $u['id_contact']; ?>" class="badge badge-danger float-center" onclick="return confirm('Yakin Data ini akan dihapus');">Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
            <a href="<?= base_url(); ?>contact/laporan_pdfcontact" class="btn btn-info">Cetak Data User</a>
        </div>
                </div>
            </div>
        </div>
