...
<center>
    &nbsp;
<h2 style="color:black"> SISTEM INFORMASI PELAYANAN KESEHATAN </h2> <br>
</center>

<div class="container">
    <div class="row mt-3">
        <div class="col-md-6" style="margin:0 auto;background-color: #A9A9A9;border-radius: 25px;color:black">
            <div class="card-body">
                ...
                <form action="" method="POST">
                    ...
                    <button type="submit" name="submit" class="btn btn-secondary float-right">Register</button><br><br>
                </form>
            </div>
        </div>
    </div>
